...
- **Board mode** — fullscreen canvas, `⊞ tools` panel lists all 62 tools grouped by unit
- **12 new tools from batch-11/12/13 video-insight passes**: Inequality Solver (u1/D7), Abs Value Equation Stepper (u1/D7), Point-Slope Form Trainer (u1/D6), Function Notation Evaluator (u1/D8), Literal Equation Isolator (u3/D9), Domain Restriction Sorter (u4/D4), Coterminal & Radians (u7/D2), Exponential Equations Stepper (u5/D6), Sincos Grapher (u7/D3–4), Linear Equations Explorer (u1/D1), **Conic Sections Explorer (u9/D4–D8)**, **Radical Equation Solver (u4/D5)**
